...
which_val_folder = "SBVPI_300x400" #"MOBIUS_300x400" # "SMD_300x400"
all_or_sclera = "sclera" # sclera, all

dest_dir = "SSBC_SEG_RESULTS/" + which_train_folder + "__" + which_val_folder